...
var fetchRelatedRecords = function (dispatch) { return function (data, field, resource) {
    return new Promise(function (resolve, reject) {
        var sanitizedData = data
            .filter(function (record) { return record[field]; })
            .map(function (record) { return record[field]; });
        // find unique keys
        var ids = new Set(sanitizedData).slice();
        dispatch({
...
var ExportButton = /** @class */ (function (_super) {
    ...
    function ExportButton() {
        ...
        _this.handleClick = function () {
            var _a = _this.props, dispatch = _a.dispatch, exporter = _a.exporter, filter = _a.filter, maxResults = _a.maxResults, sort = _a.sort, resource = _a.resource;
    ...
    ExportButton.prototype.render = function () {
        ...
        return (react_1.default.createElement(Button_1.default, __assign({ onClick: this.handleClick, label: label }, sanitizeRestProps(rest)),
