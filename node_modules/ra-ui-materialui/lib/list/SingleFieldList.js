...
var sanitizeRestProps = function (_a) {
    var currentSort = _a.currentSort, setSort = _a.setSort, isLoading = _a.isLoading, props = __rest(_a, ["currentSort", "setSort", "isLoading"]);
    return props;
};
/**
...
var SingleFieldList = /** @class */ (function (_super) {
    ...
    SingleFieldList.prototype.render = function () {
        var _this = this;
        var _a = this.props, _b = _a.classes, classes = _b === void 0 ? {} : _b, className = _a.className, ids = _a.ids, data = _a.data, resource = _a.resource, basePath = _a.basePath, children = _a.children, linkType = _a.linkType, rest = __rest(_a, ["classes", "className", "ids", "data", "resource", "basePath", "children", "linkType"]);
        return (react_1.default.createElement("div", __assign({ className: classnames_1.default(classes.root, className) }, sanitizeRestProps(rest)), ids.map(function (id) {
            ...
            if (resourceLinkPath) {
                return (react_1.default.createElement(Link_1.default, { className: classnames_1.default(classes.link, className), key: id, to: resourceLinkPath }, react_1.cloneElement(children, {
                    record: data[id],
                    resource: resource,
                    basePath: basePath,
