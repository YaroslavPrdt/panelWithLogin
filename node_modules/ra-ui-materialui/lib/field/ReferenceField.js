...
exports.ReferenceFieldView = function (_a) {
    ...
    if (resourceLinkPath) {
        return (react_1.default.createElement(Link_1.default, { to: resourceLinkPath, className: className }, react_1.default.cloneElement(children, __assign({ className: classnames_1.default(children.props.className, classes.link // force color override for Typography components
